            ...
            <div className="text-center mb-6">
              ...
              >
                ...
                <p className="text-gray-600 text-sm leading-relaxed max-w-xs mx-auto">
                  Join Finlogy and take control of your finances
                </p>
              </motion.div>
            </div>
              ...
              >
                <div className="relative">
                  <input
                    ...
                    type={showConfirmPassword ? 'text' : 'password'}
                    autoComplete="new-password"
                    className={`w-full px-4 py-4 pr-12 border-2 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 placeholder-gray-400 text-sm bg-white/80 backdrop-blur-sm shadow-sm hover:shadow-md focus:shadow-lg ${errors.confirmPassword ? 'border-red-300 focus:ring-red-500 bg-red-50/50' : 'border-gray-200/60 hover:border-blue-300'}`}
            ...
            <form className="space-y-5" onSubmit={handleSubmit(onSubmit)}>
              <div>
                ...
                <input
                  ...
                  type="text"
                  autoComplete="name"
                  className={`w-full px-3 sm:px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors placeholder-gray-400 text-sm sm:text-base min-h-[48px] ${errors.name ? 'border-red-300 focus:ring-red-500' : 'hover:border-gray-300'}`}
                  placeholder="Enter your full name"
                />
                {errors.name && (
                  <p className="mt-1 text-sm text-red-600">{errors.name.message}</p>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    type={showConfirmPassword ? 'text' : 'password'}
                    autoComplete="new-password"
                    className={`w-full px-3 sm:px-4 py-3 pr-12 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors placeholder-gray-400 text-sm sm:text-base min-h-[48px] ${errors.confirmPassword ? 'border-red-300 focus:ring-red-500' : 'hover:border-gray-300'}`}
                    placeholder="Confirm your password"
                  />
                  <button
                    type="button"
