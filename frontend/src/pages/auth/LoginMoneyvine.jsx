...
const LoginMoneyvine = () => {
  ...
  const [oauthLoading, setOauthLoading] = useState(null);
  const [loginError, setLoginError] = useState('');
  const { login, isAuthenticated, isLoading, initiateOAuth, loginAsDemo } = useAuth();
  const [ref, inView] = useInView({
    threshold: 0.1,
    triggerOnce: true,
  });
            ...
            <div className="relative z-10">
              ...
              >
                ...
                <motion.button
                  ...
                  className="w-full bg-gradient-to-r from-gray-600 to-gray-700 hover:from-gray-700 hover:to-gray-800 text-white font-semibold py-4 px-4 rounded-xl transition-all duration-300 hover:shadow-xl text-sm flex items-center justify-center shadow-lg border border-gray-500/20"
                >
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-gray-600 to-gray-700 hover:from-gray-700 hover:to-gray-800 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-200 hover:scale-[1.02] hover:shadow-lg text-sm sm:text-base min-h-[48px] flex items-center justify-center border border-gray-500/20"
              >
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
