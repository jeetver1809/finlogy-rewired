...
import ParticlesBackground from '../../components/ui/Particles'; // Create this component for background particles
          ...
          <div className="text-center" ref={ref}>
            ...
            >
              <div className="relative">
                <Logo size="lg" useCustomIcon={true} showText={false} />
                <motion.div
            ...
            >
              Sign in to your Finlogy account
            </motion.p>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={inView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
